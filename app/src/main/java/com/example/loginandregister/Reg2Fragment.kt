 ...
 * Use the [Reg2Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Reg2Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner) {
            findNavController().navigate(R.id.action_reg2Fragment_to_loginFragment)
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment Reg2Fragment.
         */
